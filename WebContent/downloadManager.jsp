	...
	<div class="main">
		<div class="menu">
			...
			<ul class="list-group list-group-flush">
				...
				<a href="DownloadManager"><li class="list-group-item active"><i
		...
		<div class="body">
			<div class="container">
				...
				<table class="table table-striped">
					...
					<tbody>
						<%
						if(session.getAttribute("myDownload") != null)
						{
						ArrayList <SongData> Datas = (ArrayList <SongData>)request.getSession().getAttribute("myDownload"); 
						...
						<tr>
							...
							<td>
								...
								<a href='#'><span class="glyphicon glyphicon-trash"
									onclick='delete_download("<%=strsongid%>","<%=email%>")'

		...
		<div class="body">
			<div class="container">
				<div class="carousel-body col-md-12">
					<div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							...
							<a href="https://music.163.com/#/song?id=1408763442" target="view_window">
							...
							<a href="https://music.163.com/#/song?id=1410490187" target="view_window">
							...
							<div class="carousel-item">
							<a href="https://music.163.com/#/song?id=1409540467" target="view_window">
				...
				<table class="table table-striped">
					...
					<tbody>
					<% 
						ArrayList <SongData> Datas = (ArrayList <SongData>)request.getSession().getAttribute("recsong"); 
					if(null != session.getAttribute("myStar"))
					{
						...
						int length=(Datas.size()>10)?10:Datas.size();
